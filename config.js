...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'CD_Kolla;10Chanuka;94742711007;https://i.imgur.com/6Gpg4Nv.jpeg;https://chat.whatsapp.com/GJcGk995BLj7iM7KndjJs1',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '. ,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'CD_Kolla',
    ...
    SUDO: process.env.SUDO || '94742711007,0',
